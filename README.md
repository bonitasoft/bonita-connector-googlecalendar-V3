...
- Run the [Create release workflow](https://github.com/bonitasoft/bonita-connector-googlecalendar-V3/actions/workflows/release.yml), set the version to release as parameter
